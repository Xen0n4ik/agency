@foreach($arr_tour as $row)
    ...
    <div
        ...
        style="
            ...
            height: 400px;
            ">
        <h1 class="display-1 shadow-5"
            style="text-align: center; color: #fff700; font-family: Garamond; font-size: 8em">
            <b>{{ $row->CITY }}</b>
        </h1>
        <h6 class="display-6 mb-5"
            style="text-align: center; color: #f4fab6; font-size: 3em; font-family: 'Segoe Script'">
            {{ $row->NAME }}
        </h6>
    </div>
    <!-- Background image -->
                ...
                <div class="row mt-0">
                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        @foreach($arr_com as $row4)
                            <div class="card" style="margin-bottom: 30px">
                                <div class="card-header"
                                     style="font-size: 2em; font-family: 'Garamond Bold'; background-color: #486eee;color: white">
                                    {{ $row4->AUTHOR }}
                                </div>
                                <div class="card-body">
                        ...
                        <form>
                            ...
                            <button type="submit" class="btn btn-primary btn-block mb-4" onclick=comment_add_tour()>
                                Отправить
                            </button>
                        </form>
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-4 mx-auto mb-md-0 mb-4">
                        ...
                        <div class="card text-white bg-primary mb-3 "
                             style="max-width: 28rem; position: -webkit-sticky;position: sticky; top: -1px">
                            <div class="card-header"
                                 style="text-align: center; font-size: 2.5em; font-family: 'Comic Sans MS'">
                                от {{ $row->COAST }} ₽
                            </div>
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-light mb-4" data-mdb-toggle="modal"
                                        data-mdb-target="#staticBackdrop"
                                        style=" margin: auto; font-size: 1.7em; display: flex">
                                    Забронировать места
                                </button>
                                ...
                                <ul style="list-style: none; text-align: center;padding: 0  ">
                                    <li style="display: inline-block">
                                        ...
                                        <p class="card-text" style="font-size: 1.3em">
                                            {{ $row->DAY }}  @if($row->DAY == 2 or $row->DAY == 3 or $row->DAY == 4 )
                                                дня @elseif($row->DAY == 1) день @else дней @endif
                                        </p>
                                    </li>

                                    <li style="display: inline-block; margin-left: 40px">
                                        <img
                                            src="https://img.icons8.com/external-prettycons-flat-prettycons/30/000000/external-moon-space-prettycons-flat-prettycons.png"/>
                                        <p class="card-text" style="font-size: 1.3em">
                                            {{ $row->NIGHT }} @if($row->NIGHT == 2 or $row->NIGHT == 3)
                                                ночи @elseif($row->NIGHT == 1) ночь @else ночей @endif
                                        </p>
                                    </li>
                                </ul>
                                ...
                                <ul style="list-style: none; text-align: center;padding: 0  ">
                                    <li style="display: inline-block;">
                                        ...
                                        <p class="card-text" style="font-size: 1.3em">
                                            {{ $row->HOTEL }} @if($row->HOTEL == 2 or $row->HOTEL == 3)
                                                ночи @elseif($row->HOTEL == 1) ночь @else ночей @endif
                                        </p>
                                    </li>
                                </ul>
            ...
            >
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header" style="font-size: 30px; text-align: center; color: #323bee"><b>БРОНИРОВАНИЕ</b>
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="flexCheckDefault" style="color: #666666">Даю <a
                                            href="{{route('agreement_index')}}" target="_blank" style="color: #0062ff">согласие на
                                            обработку перснальных данных</a></label>
                                </div>
                            </form>
                        </div>

                        <div class="modal-footer">
                            <a href="{{route('send_message')}}" class="btn btn-primary btn-block "
